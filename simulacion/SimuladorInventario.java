...
public class SimuladorInventario { 
    ...
    //cierra una ruta entre dos nodos (simula bloqueo de pasillo) - eliminar una arista
    ...
    public void simularAdicionProducto(int ubicacion, Producto producto) {
        System.out.println(">> agregando producto " + producto.codigo + " en ubicacion " + ubicacion); // mensaje de adicion
